...
public class CollectionDataBaseHelpInformation {
    ...
    public static final String HELP_MESSAGE = ANSI_PURPLE + "help" + ANSI_RESET + " : вывести справку по доступным командам\n" +
            ...
            ANSI_PURPLE + "remove_key null" + ANSI_RESET + " : удалить элемент из коллекции по его ключу\n" +
            ...
            ANSI_PURPLE + "remove_greater_key null" + ANSI_RESET + " : удалить из коллекции все элементы, ключ которых превышает заданный\n" +
